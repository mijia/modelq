...
// article.go contains model for the database table [public.article]
...
func (obj Article) Update(dbtx gmq.DbTx) (int64, error) {
	fields := []string{"UserId", "Title", "State", "Content", "Donation"}
...
func (o _ArticleObjs) Names() (schema, tbl, alias string) {
	return "public", "article", "Article"
}

func (o _ArticleObjs) Select(fields ...string) _ArticleQuery {
	q := _ArticleQuery{}
	if len(fields) == 0 {
		fields = []string{"Id", "UserId", "Title", "State", "Content", "Donation"}
	}
